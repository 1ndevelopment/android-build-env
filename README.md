...
<img src="https://files.1ndev.com/images/software/android-build-env/A.B.E.png" alt="Android Build Environment" style="max-width: 75%; height: auto; border-radius: 8px;" />
