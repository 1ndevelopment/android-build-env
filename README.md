...
<img src="https://files.1ndev.com/images/software/android-build-env/A.B.E.png" alt="Android Build Environment" width="120" align="right" style="border-radius: 8px; margin-left: 16px;" />
